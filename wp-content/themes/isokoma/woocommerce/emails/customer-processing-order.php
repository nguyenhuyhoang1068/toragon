...
<tr><td>
  <table class="td" cellspacing="0" cellpadding="0" style="width: 100%; color: #ffffff; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="0">
    ...
    <tr>
      <td style="font-size:16px; color: #ffffff !important; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;">        
      Đơn hàng số <?php echo $order->id; ?> của bạn đã được xác nhận và đang được xử lý. Thông tin đơn hàng của bạn như sau:         
      </td>
    </tr>
    <tr><td height="30"></td></tr>   
        ...
        <tr><td colspan="3" ><hr style="width:100%; border-bottom: 1px solid #ffffff;" /></td></tr>             
          ...
          if ( $item_totals ) {
            ...
            foreach ( $item_totals as $total ) {
              ...
              <tr><td colspan="3" height="10"></td></tr>
              <tr>
                <th  class="td" colspan="2" style="line-height:26px; text-align:left; font-size:16px; color: #ffffff !important; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;  border: 0px !important;"><?php echo wp_kses_post(total_label_switch_vi_vn($total['label']) ); ?></th>
...
<tr><td>
  <table class="td" cellspacing="0" cellpadding="0" style="width: 100%; color: #ffffff; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="0">
    ...
    <tr>
      <td style="font-size:16px; color: #ffffff !important; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;">        
         Your order <?php echo $order->id; ?> confirmed and being processed. Here is your order summary:        
      </td>
    </tr>
