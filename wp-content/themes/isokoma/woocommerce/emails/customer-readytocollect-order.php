<?php
/**
 * Customer Ready to collect order email
 *
...
<tr><td>
  <table class="td" cellspacing="0" cellpadding="0" style="width: 100%; color: #ffffff; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="0">
    ...
    <tr>
      <td align="left" style="font-size:16px; color: #fbcf1f !important; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;">
          <?php
          if ( $sent_to_admin ) {
    ...
    <tr>
      <td align="left" style="font-size:16px; color: #ffffff !important; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;">      
        Tin tốt dành cho bạn! Đơn hàng đã về đến cửa hàng và sẵn sàng được giao đến bạn. Thông tin đơn hàng của bạn như sau:              
      </td>
    </tr>
    <tr><td height="30"></td></tr>   
...
<tr><td>
  <table class="td" cellspacing="0" cellpadding="0" style="width: 100%; color: #ffffff; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="0">
    <?php  do_action( 'woocommerce_email_before_order_table', $order, $sent_to_admin, $plain_text, $email ); ?>
    <tr>      
      <td align="left" style="font-size:16px; text-align: left; color: #fbcf1f !important; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;">
          <?php
          if ( $sent_to_admin ) {
            $before = '<a class="link" href="' . esc_url( $order->get_edit_order_url() ) . '">';
            $after  = '</a>';
    ...
    <tr>
      ...
      Good news! Your order has arrived at the shop and is ready to be collected by you. Here is your order summary:        
      </td>
    </tr>
