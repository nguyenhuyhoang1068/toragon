...
<tr><td>
  <table class="td" cellspacing="0" cellpadding="0" style="width: 100%; color: #ffffff; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="0">
    ...
    <tr>
      <td style="font-size:16px; color: #ffffff !important; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;">   
      Đơn đặt hàng của bạn đã đến kho và đang được xử lý. Đơn hàng sẽ được thanh toán tự động thông qua phương thức thanh toán bạn đã chọn. Thông tin đơn hàng của bạn như sau:
      </td>
    </tr>
    <tr><td height="30"></td></tr>       
    ...
    <tr><td height="30"></td></tr>    
    <tr><td style="font-size:16px; color: #ffffff !important; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;">Cảm ơn bạn đã lựa chọn Toragon HE.</td></tr>    
    <tr><td height="20"></td></tr>
...
<tr><td>
  <table class="td" cellspacing="0" cellpadding="0" style="width: 100%; color: #ffffff; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="0">
    ...
    <tr>
      <td style="font-size:16px; color: #ffffff !important; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;">    
        Your preorder is now available and being processed.  You are automatically charged for your order via your selected payment method. Here is your order summary:
      </td>
    </tr>
