				...
				?>
						<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
							...
							<td class="product-thumbnail">
								...
								?>
								<?php
								echo do_shortcode('[woosw id="' . $_product->get_id() . '"]');
								?>
								<?php if ($_product->single_add_to_cart_text() === 'Pre-Order') : ?>
									<div class="pre-order">
										<?php echo 'Pre-Order'; ?>
									</div>
								<?php endif; ?>
							...
							<td class="product-cart">
								...
								<div class="woosw-content-item--stock">
									<?php echo ($_product->is_in_stock() ? esc_html__('In stock', 'woo-smart-wishlist') : esc_html__('Out of stock', 'woo-smart-wishlist')); ?>
								</div>
