...
class WC_Stripe_Helper {
	...
	public static function get_localized_messages() {
		return apply_filters(
			...
			[
				'invalid_number'           => __( 'Số thẻ không đúng.', 'woocommerce-gateway-stripe' ),
				'invalid_expiry_month'     => __( 'The card\'s expiration month is invalid.', 'woocommerce-gateway-stripe' ),
				'invalid_expiry_year'      => __( 'The card\'s expiration year is invalid.', 'woocommerce-gateway-stripe' ),
				'invalid_cvc'              => __( 'Vui lòng kiểm tra mã bảo mật.', 'woocommerce-gateway-stripe' ),
				'incorrect_number'         => __( 'Số thẻ không đúng.', 'woocommerce-gateway-stripe' ),
				'incomplete_number'        => __( 'Vui lòng điền đầy đủ thông tin thẻ.', 'woocommerce-gateway-stripe' ),
				'incomplete_cvc'           => __( 'Vui lòng nhập mã bảo mật.', 'woocommerce-gateway-stripe' ),
				'incomplete_expiry'        => __( 'Vui lòng kiểm tra hạn sử dụng thẻ.', 'woocommerce-gateway-stripe' ),
				'expired_card'             => __( 'The card has expired.', 'woocommerce-gateway-stripe' ),
				'incorrect_cvc'            => __( 'The card\'s security code is incorrect.', 'woocommerce-gateway-stripe' ),
				'incorrect_zip'            => __( 'The card\'s zip code failed validation.', 'woocommerce-gateway-stripe' ),
				'invalid_expiry_year_past' => __( 'Vui lòng kiểm tra hạn sử dụng thẻ.', 'woocommerce-gateway-stripe' ),
