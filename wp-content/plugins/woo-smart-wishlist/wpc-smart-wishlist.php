...
! defined( 'WOOSW_VERSION' ) && define( 'WOOSW_VERSION', '2.8.6' );
                                ...
                                <form method="post" action="options.php">
                                    ...
                                    <table class="form-table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="woosw_localization[button]"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="woosw_localization[button_added]"
                                                       value="<?php echo esc_attr( self::localization( 'button_added' ) ); ?>"
                                                       placeholder="<?php esc_attr_e( 'Browse wishlist', 'woo-smart-wishlist' ); ?>"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th><?php esc_html_e( 'Added to the wishlist message', 'woo-smart-wishlist' ); ?></th>
                                            <td>
                                                <input type="text" name="woosw_localization[added_message]"
                                        ...
                                        <tr>
                                            <th><?php esc_html_e( 'Already in the wishlist message', 'woo-smart-wishlist' ); ?></th>
                                            <td>
                                                <input type="text" name="woosw_localization[already_message]"
                                        ...
                                        <tr>
                                            <th><?php esc_html_e( 'Removed from wishlist message', 'woo-smart-wishlist' ); ?></th>
                                            <td>
                                                <input type="text" name="woosw_localization[removed_message]"
                                        ...
                                        <tr>
                                            <th><?php esc_html_e( 'Empty wishlist message', 'woo-smart-wishlist' ); ?></th>
                                            <td>
                                                <input type="text" name="woosw_localization[empty_message]"
                                        ...
                                        <tr>
                                            <th><?php esc_html_e( 'Product does not exist message', 'woo-smart-wishlist' ); ?></th>
                                            <td>
                                                <input type="text" name="woosw_localization[not_exist_message]"
                                        ...
                                        <tr>
                                            <th><?php esc_html_e( 'Have an error message', 'woo-smart-wishlist' ); ?></th>
                                            <td>
                                                <input type="text" name="woosw_localization[error_message]"
                                        ...
                                        <tr>
                                            <th><?php esc_html_e( 'Need to login message', 'woo-smart-wishlist' ); ?></th>
                                            <td>
                                                <input type="text" name="woosw_localization[login_message]"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="woosw_localization[popup_heading]"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="woosw_localization[add_note]"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="woosw_localization[save_note]"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="woosw_localization[open_page]"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="woosw_localization[continue]"
                                                       value="<?php echo esc_attr( self::localization( 'continue' ) ); ?>"
                                                       placeholder="<?php esc_attr_e( 'Continue shopping', 'woo-smart-wishlist' ); ?>"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th><?php esc_html_e( 'Wishlist menu item label', 'woo-smart-wishlist' ); ?></th>
                                            <td>
                                                <input type="text" name="woosw_localization[menu_label]"
                        ...
                        <div class="woosw-inner">
                            <div class="woosw-content">
								...
								<span class="woosw-page">
									<a href="<?php echo self::get_url( self::get_key() ); ?>"><?php echo self::localization( 'open_page', esc_html__( 'Open wishlist page', 'woo-smart-wishlist' ) ); ?></a>
								</span>
